...
public class CombineMaterial : MonoBehaviour, IDropHandler
{
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (!SkillManager.Inst.Materials.Contains(Data)) return;
        else if(SkillManager.Inst.Materials.Contains(Data))
        {
            mySkillData = Data;
        }
        if (mySkillData != null)
